...
<div class="user-profile-cover-div"><div class="container">
	<div class="row">
				<div class="col-12 col-sm-12 col-md-3 text-center ">
						<div class="w-100">	<img width="205" height="205" class="card-profile-img-nw" border="0" src="<?php echo projecttheme_get_avatar($uid, 205, 205); ?>" id='single-project-avatar' /></div>
				...
				<div class="col-12 col-sm-12 col-md-7 user-profile-main-info  ">
									<h1 class="mt-3 user-name-h1"><?php echo  (!empty($usr_nm) ? $usr_nm : $username) ; ?></h1>
