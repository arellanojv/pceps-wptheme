...
<div class="page-header">
              <h1 class="page-title">
                <?php echo sprintf(__('Account Settings','ProjectTheme')  ) ?>
              </h1>
            </div></div></div>
...
<div class="col-sm-12 col-lg-12">
           ...
           <?php
				...
				if(isset($_POST['save-info']))
				{
					...
					update_user_meta($uid, 'user_location', $user_location);
										...
										update_user_meta($uid, 'user_position', $user_position);
	...
	<?php do_action('projecttheme_personal_info_page_above_main_form') ?>
			...
			<div class="card"><div class="card-body"> <div class="row">
				...
				<div class="col-md-12">
					<div class="form-group">
										...
										<input type="text" size="35" name="user_location" value="<?php echo get_user_meta($uid, 'user_location', true); ?>" class="form-control" />
					</div>
        </div>
			...
			<div class="col-md-12">
				<div class="form-group">
									<label class="form-label"><?php echo __('Your Role/Position','ProjectTheme'); ?></label>
									<input type="text" size="35" name="user_position" value="<?php echo get_user_meta($uid, 'user_position', true); ?>" class="form-control" />
				</div>
			</div>
	...
	<div class="col-md-12">
	 ...
	 Dropzone.autoDiscover = false;
		...
		?>
								...
								<br/>
								*<?php _e('You need to select both categories and locations. If you want to receive a notification for a category, but the locations doesnt matter for you, then you need to select all locations.','ProjectTheme'); ?></div></div>
