 ...
 jQuery(document).ready(function() {
   jQuery("#filters-button-show-hide").click(function(){
     jQuery("#filter-optns").slideToggle();
        ...
        <div id="right-sidebar" class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
...
<form method="get" id="filter-optns">
  ...
  <div class="my_row_m1">
        ...
        <div class="full_width_m1"><input type="text"  class="do_input_search_provider form-control" value="<?php echo htmlentities($_GET['username']); ?>" name="username" /></div>
  </div>
  ...
  <div class="my_row_m1">
        ...
        <div class="full_width_m1" style="float: right; width: auto"><input type="checkbox" value="1" name="online" id="onlinestatus" <?php echo $_GET['online'] == "1" ? "checked='checked'" : "" ?>   /></div>
                      ...
                      <div class="my_row_m1 apply-filters-button-container"><div class="full_width_m1">
                        <input type="submit"  value="<?php _e('Apply Filters','ProjectTheme'); ?>" class="btn btn-block btn-primary"   name="search_provider" />
                      </div></div>
...
<?php
    ...
    //  $wpdb->print_error();
          ...
          echo '<div class="card provider-search-card p-3 pt-4 pb-4">';
