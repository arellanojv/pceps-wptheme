...
***************************************************************************/
  ...
  if($projectTheme_get_winner_bid->uid != $current_user->ID and $current_user->ID != $post->post_author)
  {
...
if($row->user == $current_user->ID)
{
                                                  ...
                                                  <div class="dt_space"><?php echo date_i18n('d-M-Y H:i:s', $row->datemade ) ?></div>
                                                                        ...
                                                                        <div class="cnd_space"><?php echo strip_tags($row->content,'<br>') ?>
                                                                          ...
                                                                          if(!empty($row->attached))
                                                                          {
                                                                              ...
                                                                              $ppst = get_post($row->attached);

                                                                          echo '<br/>'.sprintf(__('File Attached: %s','ProjectTheme') ,
                                                                          '<a href="'.wp_get_attachment_url($row->attached).'">'.$ppst->post_title."</a>") ;
 ...
 ?>
                ...
                <div class="card p-3"><div class="padd10 wk-cnt1">
                  ...
                  <div class="pb-2"><textarea name="text_message" rows="" required cols="" class="txt-ar-chat form-control mb-3"></textarea></div>
