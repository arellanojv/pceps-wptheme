	...
	<div class="project-signle-content-main card">
			 ...
			 <div class="kt-portlet__head">
				 <div class="kt-portlet__head-label">
						 <h3 class="kt-portlet__head-title">
							 <?php _e('Project Main Details','ProjectTheme') ?>
						 </h3>
				 </div>
			 </div>
	 ...
	 if($closed == "0") : ?>
				 ...
				 <div class="row">
					 ...
					 <div class="col-md-8 column-details-2"><?php echo ProjectTheme_get_budget_name_string_fromID(get_post_meta(get_the_ID(), 'budgets', true)); ?></div>
				 </div>
	...
	<div class="col-md-8 column-details-2"><?php
		 ...
		 ?>
			 ...
			 <div class="row">
					 ...
					 <div class="col-md-8 column-details-2"><?php the_time("jS F Y g:i A"); ?></div>
				 </div>
								 ...
								 ?>
									...
									<?php } ?>
										 ...
										 <div class="w-100 mb-3">
											 <a href="#" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#bidding-panel-modal"  ><?php printf(__('EDIT BID %s','ProjectTheme'), projecttheme_get_show_price($cc->bid)); ?></a>
										 </div>
...
<?php } }//end else pay contact details ?>
	...
	<h3 class="widget-title text-center"><?php _e("Project Posted By",'ProjectTheme'); ?></h3>
	 ...
	 <div class="d-flex  mb-0">
				 ...
				 <br/><br/>
					<a href="<?php echo ProjectTheme_get_user_profile_link($post->ID, 'projects'); ?>" class="btn btn-outline-primary btn-sm btn-block"><?php _e('See More Projects by this user','ProjectTheme'); ?></a><br/>
